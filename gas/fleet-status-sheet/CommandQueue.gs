...
function _COMMANDS_() {
  return {
    upsertFleetStatus: upsertFleetStatus,
    clearFleetMachineColumns: clearFleetMachineColumns,
    setFleetToken: setFleetToken,
    describeFleetConfig: describeFleetConfig,
    describeExtensionAudit: describeExtensionAudit,
    setPcInventorySheetId: setPcInventorySheetId,
