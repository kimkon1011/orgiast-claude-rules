...
function _cmdQueue_commands() {
  return {
    ...
    'Phase_AssignRequest_draft': function (caseId) { return Phase_AssignRequest_draft(caseId); },
    'Phase_AssignRequest_sendDraft': function (caseId) { return Phase_AssignRequest_sendDraft(caseId); },
