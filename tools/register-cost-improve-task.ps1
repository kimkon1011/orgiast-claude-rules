...
$repo = Resolve-RegisterRepoRoot -Fallback (Split-Path -Parent (Split-Path -Parent $MyInvocation.MyCommand.Path)) -RequiredPaths @('tools\cost-improve-loop.mjs', 'tools\cost-weekly-improve.mjs', 'tools\nightly-bootstrap.ps1')
