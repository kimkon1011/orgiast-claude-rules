...
test('stale repo root in Arguments is rewritten to the synced repo', () => {
...
test('stale repo root in Execute is rewritten too', () => {
...
test('rewrite is skipped and reported when the script is absent from the synced repo', () => {
...
test('actions already pointing at the synced repo produce no changes', () => {
