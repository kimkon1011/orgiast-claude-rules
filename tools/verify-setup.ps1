...
foreach ($k in 'manus.env', 'deepseek.env', 'xai.env', 'openrouter.env', 'groq.env', 'cerebras.env', 'zai.env', 'mistral.env', 'kimi-api.env', 'ollama.env') { Chk ("キー: $k") (Test-Path "$H\.claude\$k") }
